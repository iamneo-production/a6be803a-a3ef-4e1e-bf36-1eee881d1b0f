...
const EmailAndSmsAnalytics = () => {
    ...
    const fetchEmailCount = async () => {
        try {
            const response = await axios.get('https://8080-daebdecafbdcafeefeedabbcfeaeaadbdbabf.project.examly.io/analytics/emailCount');
    ...
    const fetchSMSCount = async () => {
        try {
            const response = await axios.get('https://8080-daebdecafbdcafeefeedabbcfeaeaadbdbabf.project.examly.io/analytics/smsCount');
