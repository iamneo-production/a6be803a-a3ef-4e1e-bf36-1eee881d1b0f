...
const EmailAndSmsAnalytics = () => {
    ...
    const fetchEmailCount = async () => {
        try {
            const response = await axios.get('https://8080-dfbebfcfbcccfefeedabbcfeaeaadbdbabf.project.examly.io/analytics/emailCount');
    ...
    const fetchSMSCount = async () => {
        try {
            const response = await axios.get('https://8080-dfbebfcfbcccfefeedabbcfeaeaadbdbabf.project.examly.io/analytics/smsCount');
