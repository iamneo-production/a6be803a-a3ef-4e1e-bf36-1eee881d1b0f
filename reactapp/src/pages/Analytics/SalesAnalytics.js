...
const SalesAnalytics = () => {
    ...
    const fetchSalesAnalytics = async () => {
        try {
            const response = await axios.get('https://8080-bfbaabafbcacdefeedabbcfeaeaadbdbabf.project.examly.io/analytics/totalSalesPerMonth');
    ...
    const fetchSalesThisMonth = async () => {
        try {
            const response = await axios.get('https://8080-bfbaabafbcacdefeedabbcfeaeaadbdbabf.project.examly.io/analytics/salesThisMonth');
