...
const Navbar = ({ name, searchQuery, onSearchChange }) => {
  ...
  const TICKET_BASE_REST_API_URL = 'https://8080-daebdecafbdcafeefeedabbcfeaeaadbdbabf.project.examly.io/crm/ticket';
  const TASK_BASE_REST_API_URL = 'https://8080-daebdecafbdcafeefeedabbcfeaeaadbdbabf.project.examly.io/crm/task';
